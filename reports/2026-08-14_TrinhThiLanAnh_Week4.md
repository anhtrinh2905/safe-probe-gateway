...
- [Mục tiêu](#mục-tiêu)
- [1. Công việc đã thực hiện](#1-công-việc-đã-thực-hiện)
  - [1.1. API Gateway trước ứng dụng thử nghiệm](#11-api-gateway-trước-ứng-dụng-thử-nghiệm)
  - [1.2. API key và allowlist](#12-api-key-và-allowlist)
  - [1.3. Python Tool (`src/safe_probe`)](#13-python-tool-srcsafe_probe)
- [2. Giới hạn đã áp dụng](#2-giới-hạn-đã-áp-dụng)
- [3. Payload an toàn sử dụng](#3-payload-an-toàn-sử-dụng)
- [4. Không dùng payload phá hoại, không đổi dữ liệu thật](#4-không-dùng-payload-phá-hoại-không-đổi-dữ-liệu-thật)
- [5. Sản phẩm bàn giao](#5-sản-phẩm-bàn-giao)
- [6. Tiêu chí hoàn thành](#6-tiêu-chí-hoàn-thành)
- [7. Chi tiết: Lab-app](#7-chi-tiết-lab-app)
  - [7.1. Khái niệm](#71-khái-niệm)
  - [7.2. Danh sách endpoint](#72-danh-sách-endpoint)
  - [7.3. Bằng chứng liên quan đến lab-app](#73-bằng-chứng-liên-quan-đến-lab-app)
- [8. Chi tiết: Juice Shop](#8-chi-tiết-juice-shop)
  - [8.1. Allowlist](#81-allowlist)
  - [8.2. Sơ đồ](#82-sơ-đồ)
  - [8.3. Bằng chứng liên quan đến Juice Shop](#83-bằng-chứng-liên-quan-đến-juice-shop)
- [9. Nhật ký không lộ API key](#9-nhật-ký-không-lộ-api-key)
- [10. Lớp LLM đề xuất probe](#10-lớp-llm-đề-xuất-probe)
  - [10.1. Khái niệm](#101-khái-niệm)
  - [10.2. Cách hoạt động](#102-cách-hoạt-động)
  - [10.3. Kiến trúc](#103-kiến-trúc)
